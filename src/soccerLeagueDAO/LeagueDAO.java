...
public class LeagueDAO {
	...
	public static List<League> listLeague() {
		TypedQuery<League> query = emDAO.getEM().createQuery("SELECT league FROM league league", League.class);
		return query.getResultList();
	}

	public static League findLeagueById(int id) {
		League league = emDAO.getEM().find(League.class, Integer.toString(id));
		return league;
	}

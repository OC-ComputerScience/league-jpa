...
//		add(list);
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentFrame.getContentPane()
						.add(new PlayerEdit(new Player(), team, league, currentFrame, isAdd, true));
				currentFrame.getContentPane().revalidate();
			}
		});
		add(btnAdd);
		...
		btnUpdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentFrame.getContentPane().add(
						new PlayerEdit((Player) list.getSelectedValue(), team, league, currentFrame, isAdd, false));
				currentFrame.getContentPane().revalidate();
		...
		if (!isAdd)
			comboBox.setSelectedItem(team.getHomeLocation());
